...
pause.addEventListener("click", function () {
    pause.classList.toggle('clickon');

    if (pause.classList.contains("clickon")) {
        // play 버튼일 때

        swiper.autoplay.stop();
        num_swiper.autoplay.stop();
        console.log("Autoplay 정지");
    } else {
        // pause 버튼일 때
        swiper.autoplay.start();
        num_swiper.autoplay.start();
        console.log("Autoplay 시작");
    }
});
/* //////////////////////////////////////////////////////// */
